...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildSettingsScreen() {
    ...
    return ListView(
      ...
      children: [
        ...
        // Backup & Restore section: single entry that opens the dedicated screen
        ...
        Card(
          ...
          child: ListTile(
            ...
            subtitle: Text(
              'Manage Google Drive backups and restores',
              style: TextStyle(
                color: Theme.of(context).colorScheme.onSurfaceVariant,
              ),
            ),
  ...
  // Backup inline helper methods removed; use the dedicated BackupRestoreScreen
}
